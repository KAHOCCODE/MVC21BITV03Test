...
<<<<<<< Updated upstream
        => optionsBuilder.UseSqlServer("Data Source=LAPTOP-3DO1R46N\\ACERSERVER;Initial Catalog=CarDealer;Integrated Security=True;Trust Server Certificate=True");
=======
        => optionsBuilder.UseSqlServer("Data Source=LAPTOP-QBAUIQJE\\PIEMON;Initial Catalog=CarDealer;Integrated Security=True;Trust Server Certificate=True");
>>>>>>> Stashed changes
